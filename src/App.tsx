      ...
      <div className="arlo_tm_wrapper_all">
        ...
        <div className="arlo_tm_mobile_header_wrap">
          <div className="main_wrap">
            <div className="logo">
              <a href="index.html"><img src="../public/img/logo/mobile_logo.png" alt="mobile_logo" /></a>
            </div>
          ...
          <div className="arlo_tm_leftpart_wrap">
            <div className="leftpart_inner">
              <div className="logo_wrap">
                <a href="#"><img src="../public/img/logo/desktop-logo.png" alt="desktop-logo" /></a>
              </div>
                        ...
                        <div className="leftbox">
                          <div className="about_image_wrap parallax" data-relative-input="true">
                            <div className="image layer" data-depth="0.1">
                              <img src="../public/img/about/550x640.jpg" alt="550x640" />
                              <div className="inner" data-img-url="../public/img/about/1.jpg"></div>
                            </div>
                    ...
                    <div className="list_wrap">
                      <ul>
                        <li>
                          <div className="inner">
                            <div className="icon">
                              <img className="svg" src="../public/img/svg/camera-diaphragm.svg" alt="camera-diaphragm" />
                            </div>
                        ...
                        <li>
                          <div className="inner">
                            <div className="icon">
                              <img className="svg" src="../public/img/svg/new-tab.svg" alt="new-tab" />
                            </div>
                            <div className="title_service">
                              <h3>Web Design</h3>
                            </div>
                        ...
                        <li>
                          <div className="inner">
                            <div className="icon">
                              <img className="svg" src="../public/img/svg/layers.svg" alt="layers" />
                            </div>
                            <div className="title_service">
                              <h3>Branding</h3>
                            </div>
                        ...
                        <li>
                          <div className="inner">
                            <div className="icon">
                              <img className="svg" src="../public/img/svg/share.svg" alt="share" />
                            </div>
                            <div className="title_service">
                              <h3>Social Media</h3>
                            </div>
                        ...
                        <li>
                          <div className="inner">
                            <div className="icon">
                              <img className="svg" src="../public/img/svg/adobe-illustrator.svg" alt="adobe-illustrator" />
                            </div>
                            <div className="title_service">
                              <h3>Illustrator</h3>
                            </div>
                        ...
                        <li>
                          <div className="inner">
                            <div className="icon">
                              <img className="svg" src="../public/img/svg/seo-performance-marketing-graphic.svg" alt="seo-performance-marketing-graphic" />
                            </div>
                            <div className="title_service">
                              <h3>Marketing</h3>
                            </div>
                        ...
                        <li className="design">
                          <div className="entry arlo_tm_portfolio_animation_wrap" data-title="Aoc Productions" data-category="Design">
                            <a href="portfolio-single.html">
                              <img src="../public/img/portfolio/600x600.jpg" alt="600x600" />
                              <div className="arlo_tm_portfolio_image_main" data-img-url="../public/img/portfolio/1.jpg"></div>
                            </a>
                          </div>
                        </li>
                        <li className="photography">
                          <div className="entry arlo_tm_portfolio_animation_wrap" data-title="Ind Hed" data-category="Photography">
                            <a href="portfolio-single-2.html">
                              <img src="../public/img/portfolio/600x600.jpg" alt="600x600" />
                              <div className="arlo_tm_portfolio_image_main" data-img-url="../public/img/portfolio/2.jpg"></div>
                            </a>
                          </div>
                        </li>
                        <li className="development">
                          <div className="entry arlo_tm_portfolio_animation_wrap" data-title="Paper Mockup" data-category="Development">
                            <a href="portfolio-single-3.html">
                              <img src="../public/img/portfolio/600x600.jpg" alt="600x600" />
                              <div className="arlo_tm_portfolio_image_main" data-img-url="../public/img/portfolio/3.jpg"></div>
                            </a>
                          </div>
                        </li>
                        <li className="photography">
                          <div className="entry arlo_tm_portfolio_animation_wrap" data-title="The Nordic" data-category="Photography">
                            <a href="portfolio-single-4.html">
                              <img src="../public/img/portfolio/600x600.jpg" alt="600x600" />
                              <div className="arlo_tm_portfolio_image_main" data-img-url="../public/img/portfolio/4.jpg"></div>
                            </a>
                          </div>
                        </li>
                        <li className="design">
                          <div className="entry arlo_tm_portfolio_animation_wrap" data-title="Creatives Castle" data-category="Design">
                            <a href="portfolio-single-5.html">
                              <img src="../public/img/portfolio/600x600.jpg" alt="600x600" />
                              <div className="arlo_tm_portfolio_image_main" data-img-url="../public/img/portfolio/5.jpg"></div>
                            </a>
                          </div>
                        </li>
                        <li className="photography">
                          <div className="entry arlo_tm_portfolio_animation_wrap" data-title="White Bag" data-category="Photography">
                            <a href="portfolio-single-6.html">
                              <img src="../public/img/portfolio/600x600.jpg" alt="" />
                              <div className="arlo_tm_portfolio_image_main" data-img-url="../public/img/portfolio/6.jpg"></div>
                            </a>
                          </div>
                        </li>
                      </ul>
                      ...
                      <ul className="total">
                        <li className="wow fadeInUp" data-wow-duration="1.2s">
                          <div className="inner_list">
                            <div className="image_wrap">
                              <img className="small" src="../public/img/blog/500x350.jpg" alt="" />
                              <img className="big" src="../public/img/blog/1170x450.jpg" alt="" />
                              <div className="news_image" data-url="../public/img/blog/1.jpg"></div>
                        ...
                        <li className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
                          <div className="inner_list">
                            <div className="image_wrap">
                              <img className="small" src="../public/img/blog/500x350.jpg" alt="" />
                              <img className="big" src="../public/img/blog/1170x450.jpg" alt="" />
                              <div className="news_image" data-url="../public/img/blog/2.jpg"></div>
                              <a className="link_news" href="index.html"></a>
                            </div>
                            <div className="definitions_wrap">
                              <div className="date_wrap">
                        ...
                        <li className="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.4s">
                          <div className="inner_list">
                            <div className="image_wrap">
                              <img className="small" src="../public/img/blog/500x350.jpg" alt="" />
                              <img className="big" src="../public/img/blog/1170x450.jpg" alt="" />
                              <div className="news_image" data-url="../public/img/blog/3.jpg"></div>
                              <a className="link_news" href="index.html"></a>
                            </div>
                            <div className="definitions_wrap">
                              <div className="date_wrap">
